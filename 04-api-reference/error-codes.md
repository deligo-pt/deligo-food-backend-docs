...
| Order | `CANNOT_ACCEPT_ORDER_FROM_CURRENT_STATUS`, `ORDER_MUST_BE_PENDING_TO_ACCEPT`, `INVALID_PICKUP_CODE`, `ORDER_ALREADY_CLAIMED_OR_EXPIRED`, `NO_PARTNER_FOUND`, `PARTNER_ALREADY_HAS_ACTIVE_ORDER` |
